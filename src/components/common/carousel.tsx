...
const Carousel = ({
	...
	return (
		...
		>
			<LeftArrow
				className={classNames("fill-current w-14 h-14 mx-2 hidden lg:flex", {
			...
			<div className="flex flex-row items-center mt-6 lg:mt-0">
				<LeftArrow
					className={classNames("fill-current w-14 h-14 mx-2 flex lg:hidden", {
						"text-tan hover:text-tan-high": color === "tan",
						"text-white hover:text-schist-low": color === "white",
						"text-black hover:text-schist-high": color === "black",
					})}
				...
				/>
				<RightArrow
					className={classNames("fill-current w-14 h-14 mx-2", {
						"text-tan hover:text-tan-high": color === "tan",
						"text-white hover:text-schist-low": color === "white",
						"text-black hover:text-schist-high": color === "black",
					})}
