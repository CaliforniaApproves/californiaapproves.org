...
export const ActionButton = ({
	...
	const classNames = classnames(
		...
		{
			"bg-orange hover:bg-orange-high":
				variant === "solid" && color === "orange",
			"bg-purple hover:bg-purple-high":
			...
			"border-orange hover:border-orange-high":
				variant === "outlined" && color === "orange",
			"border-purple hover:border-purple-high":
				variant === "outlined" && color === "purple",
			"border-green hover:border-green-high":
				variant === "outlined" && color === "purple",
			"border-black hover:border-schist-high":
