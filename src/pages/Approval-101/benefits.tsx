			...
			<div className="lg:w-1/2 lg:ml-4 my-auto px-4">
				...
				<ul className="list-disc pl-10 text-base pt-4">
					...
					<li>
						...
						Because support adds up instead of splitting apart, the winner
						reflects real, broad agreement, not just whoever survived a divided
						field.
					</li>
					<li>
						<span className="font-bold">Room for more than two. </span>
						Independent and new candidates can build real support because every
						voter is free to support them. They only have to earn support, not
						steal it from an established base.
					</li>
				</ul>
			</div>
		</div>
