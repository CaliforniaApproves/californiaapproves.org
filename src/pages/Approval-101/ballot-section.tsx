	...
	return (
		<div className="flex flex-col lg:flex-row px-8 py-10 bg-purple text-white">
			<div className="lg:w-1/2 my-auto">
				<h2>
					{"Our elections don't have to be like this! The solution is"}{" "}
					<strong className="text-tan">Approval Voting</strong>
				</h2>
				<h5 className="pt-4">
					With Approval Voting, you can vote for all the candidates you want.
