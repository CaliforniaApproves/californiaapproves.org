		...
		>
			...
			<div className="flex flex-col lg:flex-row">
				...
				<div className="lg:w-1/2 px-8 my-auto">
					<h5>
						When you enter the polling booth, you can only vote for one
						candidate. But only being able to vote for one candidate causes lots
						of problems:
					</h5>
					<ul className="list-disc pl-10 pt-4 text-base">
						...
						<li>
							...
							It is common for candidates to receive less than 50% of the vote.
						</li>
						<li>
							The system is dominated by two parties, leaving no room for new
