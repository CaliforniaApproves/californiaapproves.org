			...
			<div className="flex flex-col lg:flex-row lg:items-center">
				...
				<div className="lg:w-1/2 px-8">
					<span className="text-4xl text-white font-semibold">
						...
						candidate. That single choice can cause lots of problems:
					</span>
					<ul className="list-disc pl-10 pt-4 text-base text-white/85">
						<li>
							...
							helping the candidate you like least win. This is called “the
							spoiler effect”.
						</li>
						<li>
							<span className="font-semibold">
								Winners without broad support.{" "}
							</span>
							Winning candidates often don’t represent a broad base of voters.
							It is common for candidates to win with far less than 50% of the
							vote.
						</li>
						<li>
							<span className="font-bold">A two-party lock. </span>
							The system rewards whoever's already dominant, leaving little room
