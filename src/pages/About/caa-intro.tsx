...
const CaliforniaApprovesIntro = () => {
	return (
		<div
			className="caa-intro flex flex-col lg:flex-row items-center justify-center py-10"
			style={{
		...
		>
			<div className="flex flex-col m-auto px-8 lg:w-1/2">
				...
				<p className="text-large-bold">
					We are volunteers gathered together by our passion to reform voting in
					California. We believe that good voting reform can bring our democracy
					closer to the will of the people and reduce partisanship.
				</p>
			</div>
