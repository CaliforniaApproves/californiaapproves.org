			...
			{status === "success" ? (
				<div className="text-center py-6" role="status">
					...
					<p className="text-base text-schist-higher mt-3 leading-snug">
						{message ||
							"Thanks for signing up. Watch your inbox to confirm your subscription."}
					</p>
				</div>
			) : (
				<>
				    ...
				    Mailchimp action here would let anyone post around that check. */}
						...
						>
							<div id="mc_embed_signup_scroll">
								...
								{/* Auto-tags every submission through this form as "Newsletter" */}
								<input type="hidden" name="tags" value="527485" />
