...
const About = () => {
	...
	return (
		...
		>
			<h1 className="text-green text-center my-16">How We Are Making Waves</h1>
			<div className="flex flex-col lg:flex-row align-center">
				<div className="bg-purple text-white lg:w-80 py-[50px] px-6 rounded-t-2xl lg:rounded-t-none lg:rounded-bl-2xl h-[80%] lg:mb-10">
					...
					<p className="text-base pt-3">
						The road to better democracy starts with awareness. We offer live
						expert-led presentations for political organizations, professional
						unions, and more.
					</p>
					<br />
					<Link
				...
				<div className="bg-orange text-white lg:w-80 py-[50px] px-6 lg:rounded-b-2xl">
					<h3>Campaigning</h3>
					<p className="text-base pt-3">
						Let us help bring Approval Voting to your city. As an FPPC-approved
						committee, we are the only organization in California that can
						directly fund your campaign.
					</p>
					<br />
					<button
						type="button"
					...
					{isOpen && (
						<div
							...
							{...getFloatingProps()}
						>
							The requirements for running an approval campaign in a city vary
							depending on the laws of that city. At a minimum, there must be a
							city charter and someone living in the city willing to sign the
							application to circulate a petition. If you're interested a
							campaign{" "}
							<Link
				...
				<div className="bg-green text-white lg:w-80 py-[50px] px-6 rounded-b-2xl lg:rounded-bl-none lg:rounded-br-2xl h-[80%] lg:mb-10">
					<h3>Community</h3>
					<p className="text-base pt-3">
						Live in an area where partisanship has made the electoral process
						unrepresentative of your community? Use our platform to share your
						story and get connected.
					</p>
					<br />
					<Link
						to="mailto:info@californiaapproves.org"
