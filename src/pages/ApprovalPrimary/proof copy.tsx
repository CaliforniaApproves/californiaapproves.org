			...
			<div className="max-w-[1120px] m-auto px-8">
				<div className="max-w-full">
					...
					<p className="text-base mt-3 leading-snug">
						...
						that feeds into a top-two general, the same structure this act would
						bring to California. St. Louis voters adopted this structure for
						municipal elections in 2020. Every election since has shown the same
						pattern: candidates who once looked narrowly supported turned out to
						have much broader appeal once the ballot let voters show it.
					</p>
				</div>
					...
					{timeline.map((item) => (
						<div key={item.year}>
							...
							<div className="lg:border-t lg:border-schist lg:pt-3">
								...
								<p className="text-lg leading-normal">{item.body}</p>
							</div>
						</div>
					))}
				</div>
				...
				<div className="mt-10 pt-7 border-t border-schist max-w-full">
					<p className="text-lg leading-relaxed">
						<b className="text-green font-semibold">A stronger mandate.</b> Cara
						Spencer won the 2025 primary with 68% approval — more than double
						the 32% that was enough to win outright in 2017. Part of why: 60.6%
						of Mike Butler's supporters and 67.1% of Andrew Jones's supporters
						also approved Spencer, and even 26.9% of Tishaura Jones's own
						supporters — her closest rival in the race — crossed over to approve
						her too. That's the kind of cross-coalition support a choose-one
						ballot could never have shown, and it's what earning votes beyond
						your own dedicated base actually looks like.
					</p>
				</div>
				...
				<div className="flex flex-wrap gap-10 mt-10 pt-7 border-t border-schist">
					{surveyStats.map((stat) => (
						<div
							key={stat.pct}
							className="flex items-baseline gap-3 max-w-[450px]"
						>
