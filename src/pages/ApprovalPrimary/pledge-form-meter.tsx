...
const HeroPledge = () => {
	return (
		<div className="bg-white border-orange rounded-[50px] border-[6px] p-5 lg:p-12 text-center flex flex-col items-center gap-3">
			<h2 className="text-green">Pledge Your Support</h2>
			<p className="text-small mt-2">
				Add your name now, and we'll follow up the moment the official petition
				— with title and summary from the Attorney General — is ready to sign.
			</p>
			<div className="w-full">
				<form
					onSubmit={(e) => {
						e.preventDefault();
						console.log(
							"Form submitted (placeholder - no Mailchimp endpoint yet)",
						);
					}}
					method="post"
